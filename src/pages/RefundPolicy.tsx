  ...
  const sections: { heading: string; body: string }[] = lc?.sections || [
    {
      ...
      body: "মানাসিক ট্রাভেল হাব গ্রাহক সন্তুষ্টিকে সর্বোচ্চ গুরুত্ব দেয়। নিচে আমাদের রিফান্ড নীতির বিস্তারিত বর্ণনা করা হলো। অনুগ্রহ করে বুকিং করার আগে এই নীতি মনোযোগ দিয়ে পড়ুন।"
    },
    {
      heading: "সম্পূর্ণ রিফান্ড (১০০%)",
      body: "• মানাসিক ট্রাভেল হাব-এর পক্ষ থেকে সেবা বাতিল করা হলে\n• ভিসা প্রক্রিয়ায় মানাসিক ট্রাভেল হাব-এর ত্রুটির কারণে ভিসা না হলে\n• প্যাকেজে উল্লেখিত সেবা সম্পূর্ণরূপে প্রদান না করা হলে"
    },
    {
    ...
    },
    {
      ...
      body: "মহামারী, প্রাকৃতিক দুর্যোগ বা সরকারি নিষেধাজ্ঞার কারণে যাত্রা বাতিল হলে, মানাসিক ট্রাভেল হাব সম্পূর্ণ রিফান্ড অথবা ভবিষ্যৎ যাত্রার জন্য ক্রেডিট প্রদান করবে। এই ক্রেডিট ১ বছরের মধ্যে ব্যবহার করতে হবে।"
    },
    {
      heading: "যোগাযোগ",
      body: "রিফান্ড সংক্রান্ত যেকোনো প্রশ্নে যোগাযোগ করুন:\nফোন: +880 1711-999910, +880 1711-999920\nইমেইল: manasiktravelhub.info@gmail.com\nঅফিস: ৫৯৫/১, মিল্ক ভিটা রোড, তিন রাস্তার মোড়, দেওলা, টাঙ্গাইল সদর, টাঙ্গাইল"
    }
  ];
