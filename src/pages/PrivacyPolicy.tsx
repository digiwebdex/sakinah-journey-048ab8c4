...
export default function PrivacyPolicy() {
  ...
  const sections: { heading: string; body: string }[] = lc?.sections || [
    {
      heading: "তথ্য সংগ্রহ",
      body: "মানাসিক ট্রাভেল হাব আপনার নাম, ফোন নম্বর, ইমেইল, পাসপোর্ট নম্বর, ঠিকানা এবং জরুরি যোগাযোগের তথ্য সংগ্রহ করে থাকে। এই তথ্যগুলো শুধুমাত্র হজ্জ ও উমরাহ বুকিং, ভিসা প্রসেসিং এবং ট্রাভেল সেবা প্রদানের জন্য ব্যবহৃত হয়।"
    },
    {
    ...
    {
      heading: "যোগাযোগ",
      body: "গোপনীয়তা নীতি সম্পর্কে কোনো প্রশ্ন থাকলে আমাদের সাথে যোগাযোগ করুন: ফোন: +880 1711-999910, +880 1711-999920, ইমেইল: manasiktravelhub.info@gmail.com"
    }
  ];
